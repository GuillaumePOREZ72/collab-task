...
const ProjectComponent: FC<ProjectProps> = ({
  ...
  return (
    <div
      key={project.id}
      className={`${style ? "border border-base-300 p-5 shadow-sm" : ""}text-base-content rounded-xl w-full text-left`}
    >
      ...
      <div className="flex">
        ...
        {admin === 1 && (
          <button className="btn-sm ml-3" onClick={handleDeleteClick}>
            <Trash className="w-4" />
          </button>
        )}
      </div>
